    ...
    return (
        <div className='pb-10 bg-gray-200'>
            <div className='relative h-[300px] w-full flex items-center justify-center overflow-hidden'>
                ...
                />
                <h1 className='text-5xl text-blue-800 underline font-bold relative z-10'>Notes4All</h1>
            </div>
            ...
            <div className='p-10 flex gap-3 pt-20 rounded-2xl px-50'>
                ...
                <Image className='rounded-2xl shadow-2xl' width={500} height={300} src="/attendance.png" alt="Notes4All Preview" />
            </div>

            <div className='relative flex flex-col rounded-2xl z-10 overflow-clip mt-10 shadow-2xl mx-50 bg-white'>
                <Image className='w-full rounded-2xl shadow-2xl' width={1200} height={600} src="/jwt.png" alt="JWT Authentication" />
                <div className='p-10'>
            ...
            <div className='relative flex flex-col z-10 overflow-clip mt-10 rounded-2xl shadow-2xl mx-50 bg-white'>
                <Image className='w-full rounded-2xl shadow-2xl' width={1200} height={600} src="/redux.png" alt="Redux Toolkit" />
                <div className='p-10'>
