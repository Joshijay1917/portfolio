    ...
    return (
        <div className='bg-gray-200 pb-10'>
            <div className='relative h-[300px] w-full flex items-center justify-center overflow-hidden'>
                ...
                />
                <h1 className='text-5xl text-white font-bold relative z-10'>Smart AI Payment Tracker</h1>
            </div>
            ...
            <div className='p-10 flex gap-3 pt-20 rounded-2xl px-50'>
                ...
                <Image className='rounded-2xl mb-14 shadow-2xl overflow-hidden' width={500} height={300} src="/payment.png" alt="Payment Prediction" />
            </div>
