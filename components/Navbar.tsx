...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* Main Navbar */}
      <header className="bg-white border-b border-slate-100 px-6 md:px-12 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <ul className='hidden md:flex items-center gap-8 font-medium text-gray-600 text-md tracking-wide'>
            <Link
              href={'/'}
