...
const AI_Track = () => {
  return (
    <div>
      <h1 className='text-3xl font-bold'>Smart AI Payment Tracker (Hackthon 2025)</h1>
      ...
      <div className='bg-gray-800 p-3 rounded-2xl mt-10'>
        ...
        <div className='flex justify-center items-center gap-10'>
          ...
          <div className='text-2xl flex flex-col items-center'>
            <SiTensorflow className='text-orange-400 text-6xl' />
            <p>Tensorflow.js</p>
          </div>
        </div>
        <p className='text-center text-xl mt-10'>
          Link: <a href="https://smart-payment-tracker-frontend.vercel.app">https://smart-payment-tracker-frontend.vercel.app</a>
        </p>
      </div>
    </div>
  )
